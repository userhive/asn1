...
func _() {
	...
	_ = x[ResultNetworkError-200]
	_ = x[ResultFilterCompileError-201]
	_ = x[ResultFilterDecompileError-202]
	_ = x[ResultDebuggingError-203]
	_ = x[ResultUnexpectedMessageError-204]
	_ = x[ResultUnexpectedResponseError-205]
	_ = x[ResultEmptyPasswordError-206]
}

const _Result_name = ""
...
var _Result_map = map[Result]string{
	...
	200:  _Result_name[1119:1131],
	201:  _Result_name[1131:1149],
	202:  _Result_name[1149:1169],
	203:  _Result_name[1169:1183],
	204:  _Result_name[1183:1205],
	205:  _Result_name[1205:1228],
	206:  _Result_name[1228:1246],
	4096: _Result_name[1246:1265],
}
