...
func _() {
	...
	_ = x[ResultResultsTooLarge-66]
	_ = x[ResultNotAllowedOnNonLeaf-67]
	_ = x[ResultNotAllowedOnRDN-68]
	_ = x[ResultEntryAlreadyExists-69]
	_ = x[ResultObjectClassModsProhibited-70]
	...
	_ = x[ResultCanceled-100]
	_ = x[ResultNoSuchOperation-101]
	_ = x[ResultTooLate-112]
	_ = x[ResultCannotCancel-113]
	_ = x[ResultAssertionFailed-114]
	_ = x[ResultSyncRefreshRequired-118]
	_ = x[ResultInvalidResponse-119]
	_ = x[ResultAmbiguousResponse-120]
	_ = x[ResultTLSNotSupported-121]
	_ = x[ResultIntermediateResponse-122]
	_ = x[ResultUnknownType-123]
	_ = x[ResultAuthorizationDenied-4096]
}

const _Result_name = ""
...
var _Result_map = map[Result]string{
	...
	66:   _Result_name[599:614],
	67:   _Result_name[614:633],
	68:   _Result_name[633:648],
	69:   _Result_name[648:666],
	70:   _Result_name[666:691],
	...
	100:  _Result_name[965:973],
	101:  _Result_name[973:988],
	112:  _Result_name[988:995],
	113:  _Result_name[995:1007],
	114:  _Result_name[1007:1022],
	118:  _Result_name[1022:1041],
	119:  _Result_name[1041:1056],
	120:  _Result_name[1056:1073],
	121:  _Result_name[1073:1088],
	122:  _Result_name[1088:1108],
	123:  _Result_name[1108:1119],
	4096: _Result_name[1119:1138],
}
